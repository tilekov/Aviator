...
const CartItem = ({ item }) => {
  ...
  return (
    <List.Item
    style={{width:"60vw", marginLeft:"auto", marginRight:"auto", border:"2px solid grey", marginTop:"50px", boxShadow:'3px 3px 3px grey', borderRadius:"15px"}}
      key={item.id}
